def run():
    ...
    # =====================================================
    # LOGIN HELPERS (KEPT – BUT LOGIN HANDLED IN MAIN APP)
    # =====================================================
    def hash_pwd(pwd):
        return hashlib.sha256(pwd.encode()).hexdigest()

    # ⚠️ NOTE:
    # Login is handled in All5.py
    # Keeping code here commented to avoid duplicate login crash
    ...
    # =====================================================
    # STREAMLIT CONFIG (MUST BE IN MAIN FILE ONLY)
    # =====================================================
    """
    st.set_page_config(
